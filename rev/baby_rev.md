...
So there is a base64 string which is in reverse and after it has been "unreversed", it is base64 decoded and decompressed using zlib. There is also the site given from where it was obfuscated. I wrote a small code to do this once and got the same output (a reverse b64 encoded string).<br> So I automated it with python until I get something else.
...
![image](https://github.com/user-attachments/assets/15de7860-11a5-46ed-8498-a198cad8d970)
